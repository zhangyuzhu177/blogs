  ...
  createPlane(side: number, width: number, isRoad: boolean) {
    ...
    let uniforms: Record<string, { value: unknown }> = {
      ...
      uColor: {
        ...
        value: new THREE.Color(dark.value === 'light' ? 0xFFFFFF : 0x000000),
      },
      uTime: this.uTime,
    }
...
class App {
  ...
  constructor(container: HTMLElement, options: HyperspeedOptions) {
    ...
    this.scene.background = null // 确保场景背景为null
...
<template>
  <div
    ref="hyperspeedContainer"
    class="hyperspeed-container"
    full relative overflow-hidden bg-transparent
  />
</template>
